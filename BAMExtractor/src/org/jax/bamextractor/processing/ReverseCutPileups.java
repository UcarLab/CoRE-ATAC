...
public class ReverseCutPileups implements ATACReadProcessor{

	private BufferedWriter _bw;
	
	public ReverseCutPileups(String outpath) {
		try {
	...
	public void processReads(Location l, String referenceseq, LinkedList<SAMRecord> forwardreads, LinkedList<SAMRecord> reversereads) {
		try {
			...
			f.writePileups(_bw, l, f.getCutPileupReverse(l, reversereads));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
