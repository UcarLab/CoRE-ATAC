...
public class ReverseMedianInsert implements ATACReadProcessor{

	private BufferedWriter _bw;
	
	public ReverseMedianInsert(String outpath) {
		try {
	...
	public void processReads(Location l, String referenceseq, LinkedList<SAMRecord> forwardreads, LinkedList<SAMRecord> reversereads) {
		try {
			...
			f.writeMedianInserts(_bw, l, f.getReverseMedianInserts(l, reversereads));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
